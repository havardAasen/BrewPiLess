function invoke(arg) {
    ...
    ((xhttp.ontimeout = function () {
        if (typeof arg["timeout"] != "undefined") arg.timeout();
        else xhttp.onerror(-1);
    }),
        (xhttp.onerror = function (a) {
            if (typeof arg["fail"] != "undefined") arg.fail(a);
        }));
...
export var BWF = {
    ...
    init: function (arg) {
        ...
        b.onconnect =
            typeof arg.onconnect == "undefined"
                ? function () {}
                : arg.onconnect;
